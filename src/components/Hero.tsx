...
import { ArrowRight, TrendingUp, Shield, Percent, Building2, Star, Users, Award } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-16 xl:px-20 relative">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 py-8 lg:py-14">
          ...
          <div className="flex-1 text-white space-y-6">
            ...
            <div className="flex gap-6 lg:gap-10 pt-6 border-t border-white/10">
              <div className="group">
              ...
              <div className="group">
                <div className="flex items-center gap-2">
                  <Award className="w-5 h-5 text-primary opacity-80" />
